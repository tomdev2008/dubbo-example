...
pssh -P -h hosts.txt $REMOTE_PATH/fansz-token-service-2.0.0-SNAPSHOT/bin/shutdown.sh
...
pscp -h hosts.txt $LOCAL_PATH/fansz-token/fansz-token-service/target/fansz-token-service-2.0.0-SNAPSHOT-package.tar.gz $REMOTE_PATH/
...
pssh -P -h hosts.txt  tar -xvf $REMOTE_PATH/fansz-token-service-2.0.0-SNAPSHOT-package.tar.gz -C $REMOTE_PATH/
...
pssh -P -h hosts.txt $REMOTE_PATH/fansz-token-service-2.0.0-SNAPSHOT/bin/startup.sh
sleep 3s
